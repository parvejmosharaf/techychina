<div class="box">
    ...
    <center>
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            <input type="hidden" name="business" value="techychina@qq.com">
            <input type="hidden" name="cmd" value="_cart">
            <input type="hidden" name="upload" value="1">
            <input type="hidden" name="currency_code" value="USD">
            <input type="hidden" name="return" value="http://localhost/techychina/paypal_order.php?c_id=<?php echo $customer_id; ?>">
            <input type="hidden" name="cance_return" value="http://localhost/techychina/index.php">
