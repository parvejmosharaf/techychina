...
?>
    ...
    <head>
        ...
        <title>TechyChina ! My Account</title>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="my_account.php?my_orders">Home</a></li>
                        <li>My Account</li>
...
<a style='background-color: #af0c42; text-decoration: none; padding: 10px; font-size: 130%; color: white; margin-top:20px;' href='http://techychinabd.cf/customer/my_account.php?$customer_confirm_code'>
